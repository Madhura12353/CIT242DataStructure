...
/*
*  CIT242 CIT242_Project3:   Add enhancements to linked list class.
*/
import java.io.File;
    ...
    static void processCommand(String[] commandArgs) {
        ...
        if (commandArgs.length < 1) {
            ...
            if (commandArgs.length < 2) {
                ...
                list.removeElement(commandArgs[1]);
            }
        }
        else if (commandArgs[0].equalsIgnoreCase("INSERT")) {
            if (commandArgs.length < 2) {
                System.out.println("Usage: INSERT string");
            } else {
                list.insert(commandArgs[1].toLowerCase());
            }
        } else {
    ...
    static ArrayList<String> loadFromFile(String fName) {
        ...
        try {
            ...
            while (input.hasNextLine()) {
                ...
                lineNum++;
                contents.add(inputText.trim().toLowerCase());
            }
